...
class ProjectActivityServiceIntegrationSpec extends IntegrationSpec {
    ...
    private static createHierarchy() {
        ...
        ProjectActivity projectActivity1 = new ProjectActivity(projectActivityId: "proAct1", projectId: project.projectId, description: "d", name: "n", startDate: new Date(), status: ACTIVE, isDataManagementPolicyDocumented: false, dataAccessMethods: ["na"], dataQualityAssuranceMethods: ["dataownercurated"], "nonTaxonomicAccuracy": "low", "temporalAccuracy": "low", "speciesIdentification": "low", "spatialAccuracy": "low", methodType     : "opportunistic", methodName: "Opportunistic/ad-hoc observation recording", dataSharingLicense: "CC BY").save(failOnError: true, flush: true)
