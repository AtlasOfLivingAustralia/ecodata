...
class ProjectActivityControllerSpec extends IntegrationSpec {
    ...
    void "test create project activity"() {
        setup:
        def projectActivity = [name: 'Test Project Activity', description: 'Test description',status:'active',commentsAllowed:true,
                       startDate:'2015-06-17T14:00:00Z', endDate:'2015-06-17T14:00:00Z',
                       dynamicProperty: 'dynamicProperty', projectId:'test-project-id']
