...
class ManagementUnitController {
    ...
    def generateReportsInPeriod(){
        try{
            Map message = managementUnitService.generateReportsInPeriods(params.startDate, params.endDate, params.reportDownloadBaseUrl, params.senderEmail, params.systemEmail,params.email,params.summaryFlag)
