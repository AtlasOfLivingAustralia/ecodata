...
class ProjectController {
    ...
    def asXlsx(project) {
        ...
        ProjectXlsExporter projectExporter = new ProjectXlsExporter(projectService, exporter, managementUnitService, organisationService, programService, metadataService)
