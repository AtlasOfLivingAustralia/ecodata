...
class CSProjectXlsExporter extends ProjectExporter {
    ...
    List<String> documentHeaders = ['Project ID', 'Document ID', 'Name', 'Description', 'Role', 'Content type', 'Citation', 'ISBN', 'Labels', 'Filename', 'URL', 'Video', 'Date created', 'Last updated']
    List<String> documentProperties = ['projectId', 'documentId', 'name', 'description', 'role', 'contentType', 'citation', 'isbn', 'labels', 'filename', 'url', 'embeddedVideo', new DatePropertyGetter('dateCreated', DateTimeParser.Style.DATE,null, null,  timeZone),new DatePropertyGetter('lastUpdated', DateTimeParser.Style.DATE,null, null,  timeZone)]
