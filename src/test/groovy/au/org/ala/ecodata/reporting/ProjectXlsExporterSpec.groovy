...
class ProjectXlsExporterSpec extends Specification implements GrailsUnitTest {
    ...
    void setup() {
        ...
        projectXlsExporter = new ProjectXlsExporter(projectService, xlsExporter, [], [], managementUnitService, organisationService, programService, metadataService, null, true)
    ...
    void "project details can be exported"() {
        ...
        projectXlsExporter = new ProjectXlsExporter(projectService, xlsExporter, [sheet], [], managementUnitService, organisationService, programService, metadataService, null)
    ...
    void "Dataset data can be exported"() {
        ...
        results[0]["Has your data been included in the Threatened Species Index?"] == "Yes"
        results[0]["Date of upload"] == "2021-02-09T13:00:00Z"
    }
    ...
    void "RLP outcomes data can be exported"() {
        ...
        then:
        1 * metadataService.findInvestmentPriorities([investmentPriorityId:["ip1", "ip2"]]) >> [[investmentPriorityId: "ip1", name:"Hillslope erosion"], [investmentPriorityId: "ip2", name: "Wind erosion"]]
        ...
        results[0]["Investment Priority/ies"] == "Hillslope erosion, Wind erosion"
    }
    ...
    void "A data description sheet can be optionally included in the download"() {
        ...
        projectXlsExporter = new ProjectXlsExporter(projectService, xlsExporter, ['MERI_Baseline'], [], managementUnitService, organisationService, programService, metadataService, dataDescription, true)
