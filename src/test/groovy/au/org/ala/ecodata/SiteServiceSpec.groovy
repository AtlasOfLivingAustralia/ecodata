...
class SiteServiceSpec extends MongoSpec implements ServiceUnitTest<SiteService> {
    ...
    def "must return precision depending on area of bounding box" () {
        ...
        where:
        precision   | bbox
        3           | ["type":"Polygon","coordinates":[[[86.220703125,-50.90303283111256],[181.845703125,-50.90303283111256],[181.845703125,1.0546279422758869],[86.220703125,1.0546279422758869],[86.220703125,-50.90303283111256]]]]
