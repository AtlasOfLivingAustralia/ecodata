...
class PermissionsControllerSpec extends Specification implements ControllerUnitTest<PermissionsController>, DataTest {
    ...
    void "Get access levels for a given base level"(String baseLevel, int result, int noOfAccessLevels) {
        ...
        AccessLevel.determinerParticipant.name() | HttpStatus.SC_OK  |  5
        AccessLevel.determiner.name()         | HttpStatus.SC_OK  |  6
        AccessLevel.projectParticipant.name() | HttpStatus.SC_OK  |  7
        AccessLevel.readOnly.name()           | HttpStatus.SC_OK  |  8
        AccessLevel.starred.name()            | HttpStatus.SC_OK  |  9
