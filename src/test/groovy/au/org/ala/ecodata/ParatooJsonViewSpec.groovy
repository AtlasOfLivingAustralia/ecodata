        ...
        Map expectedResult = [
                projects: [[
                    id:"p1", name:"Project 1", protocols: [
                        [id: "guid-1", name: "Protocol 1", version: 1, module: "module-1"],
                        [id: "guid-2", name: "Protocol 2", version: 1, module: "module-2"],
                        [id: "guid-3", name: "Protocol 3", version: 1, module: "module-3"]],
